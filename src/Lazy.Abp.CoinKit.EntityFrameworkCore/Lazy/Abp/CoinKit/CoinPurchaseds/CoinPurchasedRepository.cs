...
{
    public class CoinPurchasedRepository : EfCoreRepository<ICoinKitDbContext, CoinPurchased, Guid>, ICoinPurchasedRepository
    {
        public CoinPurchasedRepository(IDbContextProvider<ICoinKitDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }

        public override async Task<IQueryable<CoinPurchased>> WithDetailsAsync()
        {
        ...
        public async Task<List<CoinPurchased>> GetListAsync(
            string sorting = null,
        ...
        protected async Task<IQueryable<CoinPurchased>> GetListQuery(
            Guid? userId = null,
            Guid? coinProductId = null,
            decimal? minPaidAmount = null,
            decimal? maxPaidAmount = null,
