...
{
    public class CoinWalletLogRepository : EfCoreRepository<ICoinKitDbContext, CoinWalletLog, Guid>, ICoinWalletLogRepository
    {
        public CoinWalletLogRepository(IDbContextProvider<ICoinKitDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
